...
const funcionario = new Funcionario(new Date(2001, 01, 09));
 // funcionario.dataNascimento = new Date(2001, 01, 09);
...
const func = new Funcionario_03('Gabriela', 112233);
func.nome = 'Gabriela Sousa';
...
const funcionario_01: Readonly<IFuncionario> = {
  ...
  nomeEmpregado: 'Vanessa',
};

 // funcionario_01.codigoFuncionario = 887653;
 // funcionario_01.nomeEmpregado = 'Campoy';
...
funcionario_02.nomeEmpregado = 'Campoy';