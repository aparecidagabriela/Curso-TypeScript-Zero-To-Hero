...
const funcionario_01 = new Funcionario('Gabriela', 'Sousa', 'Developer');
const funcionario_02 = new Funcionario('Vanessa', 'Campoy', 'Professora');
...
const funcionario_02 = new Funcionario_01('Vanessa', 'Campoy', 'Professora');
